    ...
    <div>
      ...
      <section className={AboutStyles.cohortSection}>
        ...
        <p>
          ...
          <br />
          <br />
          <span className={AboutStyles.firstLetter}>W</span>ith my current
          ...
          <br />
          <br />
          <span className={AboutStyles.firstLetter}>C</span>ontinuously working
          over the last few months, I have been completing the cohort and
