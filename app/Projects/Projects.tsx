    ...
    return (
        <>
            ...
            <article className={ProjectsStyles.container} id="projects">
                <Link style={{textDecoration:"none"}} href='/PWP' className={ProjectsStyles.cardsSection}>
                ...
                <Link style={{textDecoration:"none"}} className={ProjectsStyles.cardsSection} href='/ClifsCatalog'>
                ...
                <Link style={{textDecoration:"none"}} className={ProjectsStyles.cardsSection} href='/CCLighting'>
            ...
            <p className={ProjectsStyles.para}>At the start of each project, I was jumping into mostly unfamiliar territory. Through completing such projects, I was able to continue expanding on my 
                knowledge, and put real world use cases into my code. 
            </p>
            <br />
            <p className={ProjectsStyles.para}>Making projects with my code has not been the only way for me to learn, personally. Lately, I have been creating blog posts on subjects that I feel
                could use some light. Some of the latest posts can be found directly on the <a className={ProjectsStyles.landingAnchor} href="./">landing page</a>.
            </p>
