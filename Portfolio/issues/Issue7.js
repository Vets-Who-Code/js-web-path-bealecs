...
function addList() { //function to create list item, used with button for adding list item
    const listItem = createElement7('li', 'List item', 'list-item');
...
createElement7('button', 'Add List Item', 'add-button'); //creates add button using function call
createElement7('button', 'Remove List Item', 'remove-button'); //creates remove button using function call
